...
import '../widgets/student/quiz_not_submitted_body_student.dart';

class QuizNotSubmittedScreen extends ConsumerWidget {
  const QuizNotSubmittedScreen({super.key});
    ...
    return const Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ZADAppBar(),
          SliverFillRemaining(
            child: QuizNotSubmittedStudentBody(),
          ),
        ],
      ),
    );
