...
class BarChartParent extends StatefulWidget {
  const BarChartParent({
    super.key,
    required this.dashboardData,
  });
  ...
  @override
  State<StatefulWidget> createState() => BarChartParentState();
}

class BarChartParentState extends State<BarChartParent> {
  @override
  Widget build(BuildContext context) {
