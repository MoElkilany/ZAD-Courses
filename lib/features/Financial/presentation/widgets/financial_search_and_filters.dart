...
import 'filters/financial_filter_column.dart';
import '../../../../main.dart';
import '../../../../router/router_utils.dart';

class FinancialSearchAndFilter extends ConsumerStatefulWidget {
  const FinancialSearchAndFilter({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _FinancialSearchAndFilterState();
}

class _FinancialSearchAndFilterState extends ConsumerState<FinancialSearchAndFilter> {
  @override
  Widget build(BuildContext context) {
    final width = MediaQuery.of(context).size.width;
    final manager = ref.watch(financialListManagerProvider.notifier);
                ...
                child: InkWell(
                  onTap: () {
                    showModalSideSheet(
                      ...
                      context: context,
                      ignoreAppBar: false,
                      body: const FinancialFilterCollumn(),
                    );
                  },
                  child: Padding(
