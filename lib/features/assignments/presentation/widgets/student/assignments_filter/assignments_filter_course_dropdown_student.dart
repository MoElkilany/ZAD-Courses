...
class AssignmentsFilterCourseDropDownStudent extends ConsumerStatefulWidget {
  const AssignmentsFilterCourseDropDownStudent({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _AssignmentsFilterCourseDropDownState();
}

class _AssignmentsFilterCourseDropDownState extends ConsumerState<AssignmentsFilterCourseDropDownStudent> {
  @override
