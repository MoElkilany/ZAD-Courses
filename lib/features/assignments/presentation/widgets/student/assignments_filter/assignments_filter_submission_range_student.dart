...
class AssignmentsFilterSubmissionRangeStudent extends ConsumerStatefulWidget {
  const AssignmentsFilterSubmissionRangeStudent({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _AssignmentsFilterSubmissionRangeState();
}

class _AssignmentsFilterSubmissionRangeState extends ConsumerState<AssignmentsFilterSubmissionRangeStudent> {
  @override
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Text(
          'assignments.submissionRange'.tr(),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        filterState.lastSubmission == null
                            ? 'assignments.lastSubmission'.tr()
                            : DateFormat.yMMMd().format(filterState.lastSubmission!),
                        style: const TextStyle(fontSize: appFontSizeLarge),
                      ),
                      const Icon(Icons.calendar_today),
                    ],
