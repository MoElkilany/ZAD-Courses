...
import 'academic_filter_state.dart';

part 'academic_filter.g.dart';

@Riverpod(keepAlive: true)
class AcademicFilter extends _$AcademicFilter {
  @override
  AcademicFilterState build() {
    return const AcademicFilterState();
  }
